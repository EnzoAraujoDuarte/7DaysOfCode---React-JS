    ...
    <App>
      <div className="bg-gray-100 min-h-screen w-screen">
        <div className="flex justify-between px-5 py-2 border-b bg-white">
          <span className="font-sans text-lg text-sky-500 lowercase">DEVSOCIAL</span>
          <div>
        ...
        <div className="container mx-auto p-10">
          <form onSubmit={handleFormSubmit}>
            <p className="text-sm text-gray-600 pl-2">Faça sua postagem agora mesmo...</p>
            <div>
              <textarea
            ...
            <div className="flex justify-between">
              ...
              <button className="bg-sky-500 p-2 rounded text-white hover:bg-sky-600">postar</button>
            </div>
          </form>
          <div className="pt-5">
            <div className="border px-4 py-2 bg-white rounded mt-5 first:mt-0">
              ...
              <div className="flex justify-between">
                ...
                <time className="text-xs text-gray-500">19/05/2024 09:00:00 AM</time>
              </div>
            </div>
          </div>
        </div>
